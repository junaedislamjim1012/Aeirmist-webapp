          ...
          >
            ...
            <div className="relative z-10 flex flex-col items-center gap-6">
               ...
               <div className="space-y-2">
                  <h2 className="text-3xl font-black uppercase tracking-tight">Creator Studio Setup</h2>
                  <p className="text-white/40 text-xs font-black uppercase tracking-[0.3em]">Set up your creator profile</p>
               </div>
               
               <div className="max-w-md text-white/50 text-sm leading-relaxed">
                  Join the community of Aeirmist creators. Setting up your creator profile unlocks monetization, advanced Analytics, and priority distribution across the platform.
               </div>

               <div className="grid grid-cols-1 md:grid-cols-2 gap-4 w-full text-left">
                  <div className="p-6 rounded-2xl bg-white/5 border border-white/5 space-y-3">
                     <ShieldCheck className="text-aeirmist-cyan" size={24} />
                     <h3 className="text-xs font-black uppercase text-white/80">Account Verification</h3>
                     <p className="text-[10px] text-white/40">Verified badge and protected content distribution across the platform.</p>
                  </div>
                  <div className="p-6 rounded-2xl bg-white/5 border border-white/5 space-y-3">
                     <TrendingUp className="text-aeirmist-magenta" size={24} />
                     <h3 className="text-xs font-black uppercase text-white/80">Creator Earnings</h3>
