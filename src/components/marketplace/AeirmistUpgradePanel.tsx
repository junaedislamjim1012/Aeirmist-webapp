    ...
    <div className="space-y-8 pb-32">
      ...
      <div className="max-w-xl mx-auto glass-panel p-6 rounded-2xl border-white/5 flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-[9px] text-white/20 font-medium uppercase tracking-[0.05em] mt-0.5">Premium features are currently unlocked for all users during our launch period.</p>
        </div>
      </div>
    </div>
  );
