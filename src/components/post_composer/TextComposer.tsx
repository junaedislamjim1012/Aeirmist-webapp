    ...
    <div className="flex flex-col h-full space-y-4">
      <div className="flex justify-between items-center text-xs text-white/40">
        ...
        <div className="flex gap-2">
          <button onClick={() => logger.info("Action coming soon")}><Undo size={16}/></button>
          <button onClick={() => logger.info("Action coming soon")}><Redo size={16}/></button>
        </div>
      </div>
      ...
      <div className="grid grid-cols-4 gap-2 pt-4 border-t border-white/10">
        {[
          ...
          <button onClick={() => logger.info("Action coming soon")} key={item.label} className="flex flex-col items-center gap-2 p-2 text-white/60 hover:text-white">
            <item.icon size={18} />
